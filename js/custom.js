...
$(".readMore").click(function(){
    ...
    $expandIntro = $("#expandIntro_hider");
    //open up the content needed - toggle the slide- if visible, slide up, if not slidedown.
    $expandIntro.slideToggle(100,function(){
        //execute this after slideToggle is done
        //change text of header based on visibility of content div
        $readMore.text(function(){
            //change text based on condition
            return $expandIntro.is(":visible")?"Close":"Read more.";
        });
    ...
    //end about expand
//start hide
$(".close").click(function(){$(".expandIntro").hide(1000);
...
//Start work-02  checkout

$(".h3_checkout02").click(function(){
    ...
    $content02 = $("#hider02");
    //open up the content needed - toggle the slide- if visible, slide up, if not slidedown.
    $content02.slideToggle(100,function(){
        //execute this after slideToggle is done
        //change text of header based on visibility of content div
        $h3_checkout02.text(function(){
            //change text based on condition
            return $content02.is(":visible")?"Close":"Check Out";
        });
...
//start hide
$(".close02").click(function(){$(".content02").hide(1000);
                             $('.h3_checkout02').html('Check out');
